...
export class Batsman extends Player {
  ...
  getStrikeRate() {
    ...
    return this.innings.reduce((acc, curr) => acc + curr.strikeRate, 0) / this.innings.length;
  }
  ...
  getProfile() {
    return {
      ...
      role: "batsman",
      totalRuns: this.innings.reduce((acc, curr) => acc + curr.runs, 0),
      inningsPlayed: this.innings.length
    };
  }
}
...
export class Bowler extends Player {
  ...
  getEconomy() {
    ...
    return this.spells.reduce((acc, curr) => acc + curr.economy, 0) / this.spells.length;
  }
  ...
  getProfile() {
    return {
      ...
      role: "bowler",
      totalWickets: this.spells.reduce((acc, curr) => acc + curr.wickets, 0),
      spellsBowled: this.spells.length
    };
  }
}
