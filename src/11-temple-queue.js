...
export class TempleQueue {
  ...
  static merge(queue1, queue2) {
    const newCapacity = queue1.#maxCapacity + queue2.#maxCapacity;
    const newQ = new TempleQueue(`${queue1.templeName}-${queue2.templeName}`, newCapacity);
    newQ.#devotees = [...queue1.toArray(), ...queue2.toArray()];
    return newQ;
  }
